...
/* $Id: mydirent.h,v 1.4 2005/10/07 18:49:30 mieg Exp $ */
...
#if !(defined(MACINTOSH) || defined(MAC_X) || defined(WIN32))
#include <sys/param.h>
#endif
...
#if defined (POSIX) || defined(SUN) || defined(SUNSVR4) || defined(SOLARIS) || defined(DEC) || defined(ALPHA) || defined(SGI) || defined(LINUX) || defined(HP) || defined (OPTERON)  || defined (INTEL_SOLARIS) || defined (MAC_X) || defined (CYGWIN)
#include <dirent.h>
  typedef struct dirent MYDIRENT ;
#endif
