 ...
 * copied on tictactoe.c, just changing the rules
 * start position is labeled 1/3/5/7/9
 */
...
int main (int argc, const char *argv[])
{
  ...
  if (0) /* exhaust all position before playing */
    {
      tttInit (&ttt, TRUE) ;
      tttImprove (&ttt) ;
      tttFindState (&ttt, ".........") ;
