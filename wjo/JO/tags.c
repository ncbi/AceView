 ...
 * HISTORY:
 * Last edited: Dec  1 11:43 1996 (srk)
 * Created: Mon Aug 29 17:09:21 1994 (mieg)
 *-------------------------------------------------------------------
 */


/* $Id: tags.c,v 1.24.2.1 1999/01/29 09:53:22 mieg Exp $  */
...
/* for Eye phenotype menu (added by jld) */
  ...
  _Cataract,
  _Coloboma,
  _Global_malformation,
  _Localised_to_eye,
  _Generalised,
  _Anophthalmos_unilateral,
  _Anophthalmos
...
/* for Eye phenotype menu (added by jld) */
  ...
  lexaddkey ("Eye", &_Eye, 0) ;
  lexaddkey ("retina", &_Retina, 0) ;
  lexaddkey ("RP", &_RP, 0) ;
  lexaddkey ("Lens", &_Lens, 0) ;
  lexaddkey ("Cataract", &_Cataract, 0) ;
  lexaddkey ("Coloboma", &_Coloboma, 0) ;
  lexaddkey ("Global_malformation", &_Global_malformation, 0) ;
  lexaddkey ("Localised_to_eye", &_Localised_to_eye, 0) ;
  lexaddkey ("Generalised", &_Generalised, 0) ;
  lexaddkey ("Anophthalmos_unilatera", &_Anophthalmos_unilateral, 0) ;
  lexaddkey ("Anophthalmos", &_Anophthalmos, 0) ;
...
extern void classHardInit (char *title) ;
...
void classInit (void)
{
  ...
  if (sessionFilName ("wspec/classes","wrm","r"))
    classHardInit ("wspec/classes") ;
