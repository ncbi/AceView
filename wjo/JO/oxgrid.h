/* $Id: oxgrid.h,v 1.6 1998/12/04 15:48:12 fw Exp $ */
/*  File: oxgrid.h
...
typedef struct OXSTUFF
  { 
    ...
    KEY   s5, c3 ;
    Array many, csegs, c3segs, axis3, extent3, ohomols ;
    Graph manyGraph ;
