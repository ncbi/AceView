...
# gunzip -c tmp/PHITS_*/$lane.hits.gz | bin/bestali -filter $species -maxHit $maxHit -countBest -exportBest -exportVenn -exportSuffix -errorProfile -aliProfile -exportMito -gzo -o tmp/COUNT/$lane
