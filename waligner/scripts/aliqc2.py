...
def usage():
	...
	print ("  --BAM | --SAM | --SAMSORTED | --SAMGZ | --merge | --view  # select which phase of the program should be run")
	print ("")
	print ("Phase 1:")
...
try:
	opts, args = getopt.gnu_getopt(sys.argv[1:], '?ho:i:I:f:h:r:ameBSg:',['BAM','SAM','SAMGZ','SAMSORTED', 'magic','merge', 'split', 'view=','group=','minAli=','fasta=','run=','nreads=','help'])
...
if input_file == "":
	...
	if file_type == "BAM":
		...
		input_stream = os.popen( "cat " + input_file + " | " + gg + " | sort -T . -k 1,1 ")
